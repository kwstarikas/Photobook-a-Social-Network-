...
public class CS359DB {
    ...
    private static final String UNAME = "csd3153"; // Share your repo to give you the credentials
    private static final String PASSWD = "c6D6Qsd$";  // Share your repo to give you the credentials
