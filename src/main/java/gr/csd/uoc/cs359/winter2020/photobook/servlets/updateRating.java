...
public class updateRating extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            String whatRating = request.getParameter("rating");
            int Id = parseInt(postID);
            ...
            if (whatRating == "1") {
                rating.setRate(1);
            } else if (whatRating == "2") {
                rating.setRate(2);
            } else if (whatRating == "3") {
                rating.setRate(3);
            } else if (whatRating == "4") {
                rating.setRate(4);
            } else {
                rating.setRate(5);
            }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(updateRating.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
